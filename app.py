...
st.markdown(
    "<h3 style='font-size:1.1rem;margin-top:0.2em; margin-bottom:0.5em;'>David Chang</h3>",
...
st.markdown(
    ...
    By combining measures of **concentration**, **closure risk**,
    and **recency of openings**, it infers some sort of narrative
